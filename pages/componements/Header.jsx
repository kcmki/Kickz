    ...
    return(
        <div key={name} className='flex text-white'>
            ...
            <div>
                ...
                <input type="number" max="10" min="1" defaultValue="1"  name="name" id="name"  className='bg-white text-black focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent rounded-full w-10 h-6 p-2 m-2' />
            </div>
        </div>
    )
}